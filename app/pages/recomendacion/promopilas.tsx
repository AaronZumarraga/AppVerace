...
const SanducheDetailScreen = () => {
  ...
  const product = {
    ...
    name: "Promo Pilas",
    price: 16,
    image: require('../../../assets/images/470140898_18004212455697669_2952221237043222814_n.jpg'),
    description: "2 pizzas Simples + 2 Gaseosas. Promoción válida todos los días. • $5 Cambia tus gaseosas por 2 Pintas."
  };
