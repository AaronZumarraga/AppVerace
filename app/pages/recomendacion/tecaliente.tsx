...
const SanducheDetailScreen = () => {
  ...
  const product = {
    ...
    name: "Té caliente",
    price: 1.5,
    image: require('../../../assets/images/tecaliente.jpg'),
    description: "Refresca tu diversión. Preparate y enfrenta la sed con una bebida caliente y disfruta al máximo."
  };
          ...
          {showNutrition && (
            <View style={styles.infoSection}>
              <View style={styles.nutritionGrid}>
                <Text style={styles.gridItem}>2 Kcal</Text>
                <Text style={styles.gridItem}>0g Grasas</Text>
                <Text style={styles.gridItem}>0.4g Carbohidratos</Text>
                <Text style={styles.gridItem}>0g Proteínas</Text>
                <Text style={styles.gridItem}>5mg Sodio</Text>
              </View>

              <View style={styles.nutritionTable}>
                {[
                    ['Peso', '500ml'],
                    ['Calorías (Kcal)', '2Kcal - 0%'],
                    ['Grasas', '0g - 0%'],
                    ['Carbohidratos Totales', '0.4g - 0%'],
                    ['Azúcares', '0g - *'],
                    ['Proteínas', '0g - 0%'],
                    ['Sodio', '5mg - 0%'],
                    ['Grasas trans', '0g - 0%'],
