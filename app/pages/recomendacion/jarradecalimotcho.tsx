...
const SanducheDetailScreen = () => {
  ...
  const product = {
    id: "jarradecalimotcho",
    name: "Jarra de calimotcho",
    price: 18,
    image: require('../../../assets/images/botellavinotinto.jpg'),
    description: "Vino tinto y cola servido en una jarra, ideal para compartir."
  };
