...
const SanducheDetailScreen = () => {
  ...
  const product = {
    id: "michelada-maracuya",
    name: "Michelada Maracuya",
    price: 1.5,
    image: require('../../../assets/images/maracuya.jpg'),
    description: "Bebida con alcohol. Cerveza con maracuya, sal, limon, salsa y especias."
  };
      ...
      <ScrollView>
        ...
        <View style={styles.header}>
          <View style={styles.leftHeader}>
            ...
            <Text style={styles.title}>Cerveza</Text>
          </View>
