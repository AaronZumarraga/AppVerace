...
const SanducheDetailScreen = () => {
  ...
  const product = {
    ...
    name: "Promo Lovers",
    price: 18,
    image: require('../../../assets/images/promolovers.jpg'),
    description: "2 pizzas Clásicas + 2 Gaseosas Promoción válida todos los días. • $5 Cambia tus gaseosas por 2 Pintas."
  };
