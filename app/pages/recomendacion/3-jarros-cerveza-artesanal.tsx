...
const SanducheDetailScreen = () => {
  ...
  const product = {
    id: "3 jarros cerveza artesanal",
    name: "3 jarros cerveza artesanal",
    price: 10,
    image: require('../../../assets/images/jarro1.jpg'),
    description: "3 Bebidas con alcohol. Cerveza artesanal de 1000 ml."
  };
