...
const SanducheDetailScreen = () => {
  ...
  const product = {
    id: "botelladeronabuelo",
    name: "Botella de Ron Abuelo",
    price: 45,
    image: require('../../../assets/images/ronabuelo.jpg'),
    description: "Ron de la marca Ron Abuelo, ideal para cócteles o disfrutar solo."
  };
