...
const SanducheDetailScreen = () => {
  ...
  const product = {
    id: "botelladecañamanabita",
    name: "Botella de caña manabita",
    price: 25,
    image: require('../../../assets/images/cañamanaba.jpg'),
    description: "Botella de caña manabita, ideal para disfrutar con amigos."
  };
