...
const SanducheDetailScreen = () => {
  ...
  const product = {
    ...
    name: "Verace",
    price: 12,
    image: require('../../../assets/images/pexels-ahmedbhutta11-7350139.jpg'),
    description: "Mozzarella, jamón, tocino, pepperoni, cebolla, pimiento, champiñones, tomate cherry y salsa de la casa."
  };
