...
const SanducheDetailScreen = () => {
  ...
  const product = {
    id: "jarradetintodeverano",
    name: "Jarra de tinto de verano",
    price: 18,
    image: require('../../../assets/images/jarratintoverano.jpg'),
    description: "Vino tinto con gaseosa de limón servido en jarra para disfrutar en grupo."
  };
