    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <TouchableOpacity onPress={() => router.back()} style={styles.backButton}>
          ...
          <Text style={styles.headerTitle}>     Iced Coffee</Text>
        ...
        {/* Imagen del producto */}
        <Image
          source={require('../../../assets/images/cafefrio.jpg')}
        ...
        <View style={styles.productInfo}>
          <Text style={styles.productTitle}>Iced Coffee</Text>
          <Text style={styles.productDescription}>
            Sinceramente bueno, iced coffee y agua caliente.
          </Text>
        </View>
