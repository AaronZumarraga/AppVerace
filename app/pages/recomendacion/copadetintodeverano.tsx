...
const SanducheDetailScreen = () => {
  ...
  const product = {
    id: "copadetintodeverano",
    name: "Copa de tinto de verano",
    price: 6,
    image: require('../../../assets/images/tintodeverano.jpg'),
    description: "Vino tinto mezclado con gaseosa de limón y un toque de hielo."
  };
