...
const SanducheDetailScreen = () => {
  ...
  const product = {
    id: "breadsticksverace",
    name: "Bread Sticks Verace",
    price: 8,
    image: require('../../../assets/images/sticks2.jpg'),
    description: "Palitos de masa y parmesano, acompañados de queso cheddar, carne y aguacate."
  };
