    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <TouchableOpacity onPress={() => router.back()} style={styles.backButton}>
          ...
          <Text style={styles.headerTitle}>     Capuccino</Text>
        ...
        {/* Imagen del producto */}
        <Image
          source={require('../../../assets/images/capuccino.jpg')}
        ...
        <View style={styles.productInfo}>
          <Text style={styles.productTitle}>Capuccino</Text>
          <Text style={styles.productDescription}>
            Sinceramente bueno, cafpuccino y agua caliente.
          </Text>
        </View>
