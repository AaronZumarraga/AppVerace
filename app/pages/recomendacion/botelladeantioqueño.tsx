...
const SanducheDetailScreen = () => {
  ...
  const product = {
    id: "botelladeantioqueño",
    name: "Botella de antioqueño",
    price: 45,
    image: require('../../../assets/images/botellaantioqueño.jpg'),
    description: "Aguardiente Antioqueño, perfecto para celebraciones."
  };
