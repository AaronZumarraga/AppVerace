...
const SanducheDetailScreen = () => {
  ...
  const product = {
    id: "promosanduchera",
    name: "Promo Sanduchera",
    price: 24,
    image: require('../../../assets/images/278953595_514677723447399_1453067101951070993_n.webp'),
    description: "2 Sanduches + 2 Gaseosas Sanduches a elección del cliente. • $5 Cambia tus gaseosas por 2 Pintas."
  };
