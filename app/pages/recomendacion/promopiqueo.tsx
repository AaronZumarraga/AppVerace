...
const SanducheDetailScreen = () => {
  ...
  const product = {
    ...
    name: "Promo Piqueo",
    price: 18,
    image: require('../../../assets/images/promopiqueo.avif'),
    description: "2 Sanduches + 1 Nacho Verace + 2 Gaseosas. Sanduches a elección del cliente. • $5 Cambia tus gaseosas por 2 Pintas."
  };
