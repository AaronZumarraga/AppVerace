...
export default function Tab() {
  ...
  return (
    <View style={styles.container}>
      <Text>Registro de sesion</Text>
      
      {/* Usamos el componente CustomTextInput */}
      <CustomTextInput
        placeholder="Ingrese el primer campo"
        value={input1}
        onChangeText={setInput1} // Actualiza el estado del primer input
      />

      <CustomTextInput
        placeholder="Ingrese el segundo campo"
        value={input2}
        onChangeText={setInput2} // Actualiza el estado del segundo input
      />

      <Button label="Registrarse" onPress={handleButtonPress} /> {/* Botón para mostrar el mensaje */}
